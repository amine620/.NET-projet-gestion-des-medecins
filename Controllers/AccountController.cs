...
namespace siteweb.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            ViewBag.type = new SelectList(db.Roles.Where(a => !a.Name.Contains("Administrateurs")).ToList(), "Name", "Name");
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await UserManager.AddToRoleAsync(user.Id, model.type);
        ...
        public ActionResult EditProfil()
        {
            ...
            EditViewModel profil = new EditViewModel();
